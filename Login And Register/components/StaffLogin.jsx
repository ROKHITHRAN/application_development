    ...
    <div className="main">
        ...
        <div className="login-popup-content" elevation={24}>
            ...
            <label>
                ...
                {!nameError && !emailError && !passwordError ? <button type='submit'><Link to='Landing' style={{textDecoration:"none",color:"white"}}>Login</Link></button> : <button type="submit">Login</button>}
            </form>
        </div>
        </div>
    </div>
